...
--[[
	...
	Based on http://blog.gbanga.com/2011/05/lua-unit-test-results-in-jenkins/
]]
Report = {
	name = '',
	path = ''
...
function Report:setName(name) end
function Report:setPath(path) end
function Report:displayClassName(currentClassName) end
function Report:displayTestName(currentTestName) end
function Report:displayFailure( errorMsg ) end
function Report:displaySuccess() end
function Report:displayOneFailedTest( failure ) end
function Report:displayFailedTests(errorList) end
function Report:displayFinalResult(testCount,failureCount) end
...
UnitResult = { -- class
	...
	function UnitResult:displayClassName()
		Report:displayClassName(self.currentClassName)
		print( '>>>>>>>>> '.. self.currentClassName )
	end

	function UnitResult:displayTestName()
		if self.verbosity > 0 then
			Report:displayTestName(self.currentTestName)
		end
	end
	...
	function UnitResult:displayFailure( errorMsg )
		if self.verbosity == 0 then
			...
			Report:displayFailure( errorMsg )
			print( errorMsg )
			print( 'Failed' )
		end
	end
	...
	function UnitResult:displaySuccess()
		Report:displaySuccess()
	end

	function UnitResult:displayOneFailedTest( failure )
		Report:displayOneFailedTest( failure )
	end

	function UnitResult:displayFailedTests()
		Report:displayFailedTests(self.errorList)
	...
	function UnitResult:displayFinalResult()
		Report:displayFinalResult(self.testCount,self.failureCount )
			print("=========================================================")
